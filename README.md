...
- Select a language: English (`en`), neutral Latin American Spanish (`es-419`), or Brazilian Portuguese (`pt-BR`).
- Choose PDF for reading or DOCX for accessibility, notes, and training use.
- Confirm current technical, legal, regulatory, and product information with authoritative sources before applying it.

## Manual Catalog

### AI Governance and Risk

| Manual | Language | PDF | DOCX |
|---|---|---|---|
...
| Manual | Language | PDF | DOCX |
|---|---|---|---|
| Kali Linux, AI Security, and Digital Forensics | English | [PDF](manuals/kali-linux-ai-security-forensics/en/Kali_Linux_AI_Security_Forensics_en_v1.0.pdf) | [DOCX](manuals/kali-linux-ai-security-forensics/en/Kali_Linux_AI_Security_Forensics_en_v1.0.docx) |
| Kali Linux, seguridad de IA y análisis forense digital | Español (Latinoamérica) | [PDF](manuals/kali-linux-ai-security-forensics/es-419/Kali_Linux_Seguridad_IA_Forense_es-419_v1.0.pdf) | [DOCX](manuals/kali-linux-ai-security-forensics/es-419/Kali_Linux_Seguridad_IA_Forense_es-419_v1.0.docx) |
| Kali Linux, segurança de IA e perícia digital | Português (Brasil) | [PDF](manuals/kali-linux-ai-security-forensics/pt-BR/Kali_Linux_Seguranca_IA_Forense_pt-BR_v1.0.pdf) | [DOCX](manuals/kali-linux-ai-security-forensics/pt-BR/Kali_Linux_Seguranca_IA_Forense_pt-BR_v1.0.docx) |

### Cloud AI Security

| Platform | Language | PDF | DOCX |
|---|---|---|---|
...
Manuals are organized by topic or cloud platform and then by language:
...
Language folders use internationally recognizable locale codes:
...
All technical material is intended for lawful, authorized, and ethical use. Use security tools and testing procedures only when you own the environment, have explicit written permission, are working in an approved laboratory, or are operating within a documented professional scope.

> **Technical ability does not create permission.**

Do not use these materials to access, test, disrupt, monitor, alter, or collect information from systems, applications, AI models, accounts, networks, or data without authorization.

## Accessibility

The project aims to provide clear language, meaningful headings, logical reading order, usable links, and accessible PDF and DOCX editions. Accessibility review is an ongoing process; publication does not represent a claim of formal WCAG or PDF/UA conformance.

See [ACCESSIBILITY.md](ACCESSIBILITY.md) for the testing and correction workflow.

## Contributions and Corrections

Corrections, accessibility improvements, translation feedback, and responsible contributions are welcome. Please read [CONTRIBUTING.md](CONTRIBUTING.md) before opening an issue or pull request.

Contributions must use authoritative information, exclude confidential data and harmful guidance, identify the affected manual and language, and explain the proposed change.

## Versioning

- `v1.0` — Initial public release
- `v1.1` — Corrections, accessibility improvements, formatting changes, or updated links
- `v1.2` — Added examples, tools, or implementation guidance
...
These materials are provided for educational and informational purposes only. They do not constitute legal, regulatory, compliance, financial, audit, certification, or other professional advice.

Readers and organizations are responsible for obtaining authorization, validating technical guidance, protecting sensitive information, performing environment-specific risk assessments, determining applicable obligations, and consulting qualified professionals when appropriate.

## License

Unless otherwise stated, original educational content is licensed under the [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License](LICENSE).
